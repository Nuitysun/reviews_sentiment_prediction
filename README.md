...
&nbsp;&nbsp;&nbsp;nbsp;nbsp;&nbsp;&nbsp; ![review_with_rating](/reviews_sentiment_calculated_from_review_rating.png) 
 
 - for all data: sentiment was calculated from review_rating or predicted by model

&nbsp;&nbsp;&nbsp;nbsp;nbsp;&nbsp;&nbsp; ![for_all data](/reviews_sentiment_calculated_from_review_rating_prediction.png) 
